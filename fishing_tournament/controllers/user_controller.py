...
#     }
#     return render_template('mg_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/verify/mens/unguided')
# def show_verify_mu():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
#     data = {
#         "division" : "Men",
#         "guided_unguided" : "Unguided"
#     }
#     return render_template('mu_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/verify/womens/guided')
# def show_verify_wg():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
...
#         "guided_unguided" : "Guided"
#     }
#     return render_template('wg_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/verify/womens/unguided')
# def show_verify_wu():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
...
#         "guided_unguided" : "Unguided"
#     }
#     return render_template('wu_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/verify/youths/guided')
# def show_verify_yg():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
...
#         "guided_unguided" : "Guided"
#     }
#     return render_template('yg_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/verify/youths/unguided')
# def show_verify_yu():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
...
#         "guided_unguided" : "Unguided"
#     }
#     return render_template('yu_verify.html', users = User.get_users_with_submissions_by_division_gu(data))

# @app.route('/leaderboard/mens/guided')
# def leaderboard_mg():
#     if 'user_id' not in session:
#         flash("You must be logged in.", "notinsession")
#         return redirect('/')
...
#         "guided_unguided" : "Guided"
#     }
#     return render_template('mg_leaderboard.html', users = User.get_users_with_submissions_by_division_gu(data))